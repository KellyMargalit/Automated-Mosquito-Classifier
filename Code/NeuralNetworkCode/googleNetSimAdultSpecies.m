...
rootFolder = 'AdultSpeciesFemale';
categories = {'Funestus','Gambiae'};
...
elseif isa(learnableLayer,'nnet.cnn.layer.Convolution2DLayer')
    newLearnableLayer = convolution2dLayer(1,2, ...
        'Name','new_conv', ...
        'WeightLearnRateFactor',10, ...
        'BiasLearnRateFactor',10);
end
...
%% Test network
netGoogleAdultSpeciesFemale2 = net;
save netGoogleAdultSpeciesFemale2;
rootFolder = 'FemaleTestSpecies';
